...
AD_K P_delta_gros = { 20, 40 };
AD_K D_delta_gros = { 5000/*7000*/, 400 };
AD_K P_alpha_gros = { 100, 15}; // { 200, 15};
AD_K D_alpha_gros = { 100 , 1000 };
long int acceleration_max_gros = 50;
...
void setGros() // Précision à 2cm et 3°
{
    ...
    AD_presDelta = 20 * MM_TO_TICKS;
    AD_presAlpha = 3.0 * TICK_TOUR / 360.0;
